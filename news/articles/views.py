...
from django.contrib.auth.mixins import LoginRequiredMixin, UserPassesTestMixin     # new - for authorizations
...
class CommentGet(DetailView): # new - renamed from ArticleDetailView to CommentGet to be responsiple for only get requests
    model = Article
